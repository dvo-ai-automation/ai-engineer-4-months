...
**Maand 1 — Python en de plumbing** · week 3 van 4

| | |
|---|---|
| **Af** | CS50P college 0 t/m 6 — Functions & Variables, Conditionals, Loops, Exceptions, Libraries, Unit Tests, File I/O |
| **Nu bezig** | De expense tracker: CLI-tool die naar JSON leest en schrijft |
| **Daarna** | venv/pip · HTTP en `requests` · SQL-basis |
...
| Pad | Inhoud |
|---|---|
| [docs/](docs/) | Het dashboard dat hierboven live staat — één self-contained HTML-bestand |
| [ROADMAP.md](ROADMAP.md) | Het plan in het kort: doel, de twee regels, de vier valkuilen |
