...
- **Wanneer gebruiken:** Maand 1, vanaf dag 1. Elke leersessie, elke error, elk stuk code dat je zelf schrijft.
- **Belangrijkste regel bij gebruik:** laat het uitleggen, jíj typt. Zodra je het je code laat schrijven terwijl je toekijkt, zit je in Fout 2 (tutorials kijken i.p.v. bouwen).
